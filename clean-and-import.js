...
async function cleanAndImport() {
  try {
    ...
    // 1. Удаляем все старые данные в правильном порядке (сначала зависимые таблицы)
