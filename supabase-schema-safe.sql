-- Безопасное создание таблиц для PixelPrint в PostgreSQL
-- Этот файл можно запускать несколько раз без ошибок

-- Создание enum для PriceRuleKind (только если не существует)
DO $$ BEGIN
...
-- Удаление таблиц если существуют (для чистого старта)
...
-- Таблица VerificationToken (NextAuth)
...
-- Создание индексов для NextAuth
